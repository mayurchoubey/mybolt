...
export const Workbench = memo(
  ({ chatStarted, isStreaming, actionRunner, metadata, updateChatMestaData }: WorkspaceProps) => {
    ...
    // Force view to always be preview for UI simplification
    useEffect(() => {
      workbenchStore.currentView.set('preview');
    }, []);

    // Ensure view stays as preview even if it changes
    useEffect(() => {
            ...
            <div className="absolute inset-0 px-2 lg:px-6">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1">
                  {/* Tab slider hidden but functional */}
                  <div className="opacity-0 pointer-events-none">
                    <Slider selected={selectedView} options={sliderOptions} setSelected={setSelectedView} />
                  </div>
                  <div className="ml-auto" />
                  {/* Code view buttons hidden but functional */}
                  <div className="opacity-0 pointer-events-none">
                    {selectedView === 'code' && (
                  ...
                  {/* Diff view dropdown hidden but functional */}
                  <div className="opacity-0 pointer-events-none">
                    {selectedView === 'diff' && (
                ...
                <div className="relative flex-1 overflow-hidden">
                  {/* Code view hidden but functional */}
                  ...
                  {/* Diff view hidden but functional */}
                  <div className="hidden">
                    <View
                      initial={{ x: '100%' }}
